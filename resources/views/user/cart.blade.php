                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>
                                    <div class="img">
                                        <a href="#"><img src="{{URL::to('image', $data->item_image)}}" alt="Image"></a>
                                        <p>{{($data->item_name)}}</p>
                                    </div>
                                </td>
                                <td>IDR {{number_format($data->item_price_sale, 0 , '.', '.')}}</td>
                                <td>
                                    <div class="qty" >
                                ...
                                <td>IDR {{number_format($data->item_price_sale * $data->qty, 0,'.','.')}}</td>
                                <td><a href="#" type="submit"><i class="fa fa-trash"></i></a></td>
                            </tbody>
                            @endforeach
                        </table>
                    </div>
