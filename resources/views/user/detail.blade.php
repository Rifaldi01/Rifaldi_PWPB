                    ...
                    <div class="row align-items-center">
                        <div class="col-md-5">
                            <div class="product-slider-single normal-slider">
                                <img src="{{URL::to('image', $detail->item_image)}}" alt="Product Image">
                                 </div>
                            <div class="product-slider-single-nav normal-slider">
                                <div class="slider-nav-img"><img src="{{URL::to('image', $detail->item_image)}}" alt="Product Image"></div>
                                </div>
                        </div>
                        <div class="col-md-7">
                            <div class="product-content">
                                <div class="title"><h2>{{$detail->item_name}}</h2></div>
                                <div class="ratting">
                                ...
                                <div class="price">
                                    ...
                                    <p>IDR {{number_format($detail->item_price_sale, 0 ,'.','.')}}</p>
                                </div>
                                <div class="p-size">
                                    <h5>Stok Barang: {{$detail->item_stok}}</h5>
                               <form action="{{URL::to('add-cart', $detail->id)}}" method="POST">
                                   @csrf
                                <div class="quantity">
                                    <h4>Quantity:</h4>
                                    <div class="qty">
                    ...
                    <div class="row align-items-center product-slider product-slider-3">
                        ...
                        <div class="col-lg-3">
                            <div class="product-item">
                                ...
                                <div class="product-image">
                                    <a href="product-detail.html">
                                        <img src="{{URL::to('assets2/img/product-4.jpg')}}" alt="Product Image">
                                    </a>
                                    <div class="product-action">
                                        <a href="#"><i class="fa fa-cart-plus"></i></a>
                                        <a href="#"><i class="fa fa-heart"></i></a>
                        ...
                        <div class="col-lg-3">
                            <div class="product-item">
                                ...
                                <div class="product-image">
                                    <a href="product-detail.html">
                                        <img src="{{URL::to('assets2/img/product-2.jpg')}}" alt="Product Image">
                                    </a>
                                    <div class="product-action">
                                        <a href="#"><i class="fa fa-cart-plus"></i></a>
                                        <a href="#"><i class="fa fa-heart"></i></a>
