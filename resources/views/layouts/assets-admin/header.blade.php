                    ...
                    <a class="dropdown-item" href="javascript:void(0);">
                        <div class="media">
                            <div class="usr-img online mr-3">
                                <img class="usr-img rounded-circle" src="{{URL::to('assets/assets/img/profile-9.jpg')}}" alt="Generic placeholder image">
                            </div>
                        ...
                        <div class="media">
                            <div class="usr-img mr-3">
                                <img class="usr-img rounded-circle" src="{{URL::to('assets/assets/img/profile-24.jpg')}}" alt="Generic placeholder image">
                            </div>
                            <div class="media-body">
                                <div class="mt-0">
                        ...
                        <div class="media">
                            <div class="usr-img online mr-3">
                                <img class="usr-img rounded-circle" src="{{URL::to('assets/assets/img/profile-3.jpg{{URL::to(')}}" alt="Generic placeholder image">
                            </div>
                            <div class="media-body">
                                <div class="mt-0">
                            ...
                            <div class="notification-item position-relative  mb-3">
                                ...
                                <ul class="list-inline badge-collapsed-img mt-3">
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="{{URL::to('assets/img/profile-2.jpg')}}" alt="admin-profile" class="ml-0">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="{{URL::to('ssets/img/profile-3.jpg')}}" alt="admin-profile">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="{{URL::to('ssets/img/profile-4.jpg')}}" alt="admin-profile">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="{{URL::to('ssets/img/profile-5.jpg')}}" alt="admin-profile">
                                    </li>
                                </ul>
